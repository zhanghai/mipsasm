...
.data 0x00001000; // 数据地址，此处 00001000H 开始定义数据
Data1: // 数据区 1, 标号
    .word 0xFFFFFF00, 0x000002AB, 0x80000000, 0x0000003F, 0x00000001, 0xFFFF0000, 0x0000FFFF, 0x80000000, 0x00000000, 0x11111111, 0x22222222, 0x33333333, 0x44444444, 0x55555555, 0x66666666, 0x77777777, 0x88888888, 0x99999999, 0xAAAAAAAA, 0xBBBBBBBB, 0xCCCCCCCC, 0xDDDDDDDD, 0xEEEEEEEE, 0xFFFFFFFF;
    .byte 0x55, 0x56, 0x57, 0x58; // db伪指令，定义数据0x55...在00001060
// TODO:    .half 'ab', 0x1234;// dw伪指令，定义数据0x41, 0x42, 0x1234在000010604
    .word 0x12345678; // dd伪指令，定义数据0x12345678在00001068

data2:
    .space 16; // data2是标号，从0000106C开始定义16个字节空间
     // 此处 00001070-00001FFC 填“00000000”。

.data 0x00002000; // 数据地址，此处 00002000H 开始定义数据
Data2: // 数据区 2, 标号
    .word 0x557EF7E0, 0xD7BDFBD9, 0xD7DBFDB9, 0xDFCFFCFB, 0xDFCFBFFF, 0xF7F3DFFF, 0xFFFFDF3D, 0xFFFF9DB9, 0XFFFFBCFB, 0XDFCFFCFB, 0XDFCFBFFF, 0XD7DB9FFF, 0XD7DBFDB9, 0XD7BDFBD9, 0XFFFF07E0, 0X007E0FFF, 0X03BDF020, 0X03DEF820, 0X08002300;
    // 此处从0000204C-0000BFFC填“00000000”。

.data 0x0000C000; // 数据地址，此处0000C000H开始定义数据
buffer:
    .space 128; // 数据区3，buffer标号=0000C000，定义32个32位字空间，到 0000C080 结束
