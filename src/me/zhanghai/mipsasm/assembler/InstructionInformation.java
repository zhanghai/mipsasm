...
public enum InstructionInformation {
    ...
    DIVU(Operation.DIVU, OperandListPrototypes.SOURCE_SOURCE2, InstructionAssemblers.SOURCE_SOURCE2,
            InstructionDisassemblers.SOURCE_SOURCE2),
    DERET(Operation.DERET, OperandListPrototypes.EMPTY, InstructionAssemblers.CO0, InstructionDisassemblers.CO0),
    ERET(Operation.ERET, OperandListPrototypes.EMPTY, InstructionAssemblers.CO0, InstructionDisassemblers.CO0),
    ...
    TLBWR(Operation.TLBWR, OperandListPrototypes.EMPTY, InstructionAssemblers.CO0, InstructionDisassemblers.CO0),
